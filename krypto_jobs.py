...
candidate_database = {
    "Lane": [
        "Lane",
        "0xa8Ae38B28389F3249E9ee8301b155B79512100E2",
        "4.3",
        0.20,
        "Images/lane.jpeg",
    ],
...
st.sidebar.write("##Total Wages :", wages)
...
if st.sidebar.button("Send Transaction"):
    ...
    if hours > 0:
      ...
      if ether <= wages:
        ...
        st.sidebar.write("With a balance of", ether, "ether, you cannot afford to hire..", candidate )
      ...
      st.sidebar.write("Number of hours cannot be less than 0. Please enter valid number of hours.")
